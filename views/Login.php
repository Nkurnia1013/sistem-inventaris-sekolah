<div class="row align-items-center" style="height: 60vh" >
    <div class="mx-auto  col-5 mb-2">
        <div class="card rounded shadow" style="zoom:85%">
            ...
            <img src="mine/login.png" class="w-50  rounded" >
        </div>
            <h5 class="text-dark ml-2 text-center mt-1 pt-1">Form Login</h5>
            <div class=" card-body ">
                <form  method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="form-grup col-12 mb-2 input-group-sm">
                            <label class="form-control-label">Username</label>
                            <input type="text"  class="form-control" maxlength="25" name="user">
                        </div>
                        <div class="form-grup col-12 mb-2 input-group-sm">

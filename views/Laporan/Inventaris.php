                        ...
                        <table style="zoom:100%" class="table card-table table-bordered p-2 table-vcenter" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php endif;?>
                                    <?php endforeach;?>
                                    <td><?php echo $data['transaksi']->where('idbarang', $e->idbarang)->where('jenis', 'Masuk')->sum('qty'); ?></td>
                                    <td><?php echo $data['transaksi']->where('idbarang', $e->idbarang)->where('jenis', 'Keluar')->where('status', 'Acc')->sum('qty'); ?></td>
